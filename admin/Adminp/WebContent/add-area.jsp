		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Add Area</h3>
					<div class="row">
						<div class="col-md-12">
							<!-- INPUTS -->
							<div class="panel">
								...
								<div class="panel-body">
									<form action="areacon" method="post">
										<div class="form-group">
											...
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" placeholder="Area Name" name="a_name"></div>
