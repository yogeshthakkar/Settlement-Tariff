		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12"><h3 class="page-title">Manage User<a href="add-user.jsp"><button type="button" class="btn btn-default right"><i class="fa fa-plus-square"></i> Add User</button></a></div></h3>
					</div>
									...
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												...
												<td>Jobs</td>
												<td>
													<a href="edit-user.jsp"><button class="btn btn-action-edit"><span class="fa fa-pencil"></span></button></a>&nbsp;
													<a><button class="btn btn-action-delete"><span class="fa fa-trash"></span></button></a>
												</td>
											</tr>
										</tbody>
									</table>
