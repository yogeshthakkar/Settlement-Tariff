								...
								<div class="panel-body">
									<form action="addsubcategory" method="post">
										<div class="form-group">
											...
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" placeholder="Sub-Category Name" name="sb_name"></div>
											<div class="clearfix"></div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label" for="textinput"><span>Status</span></label>
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" placeholder="Status" name="status"></div>
											<div class="clearfix"></div>
										</div>
