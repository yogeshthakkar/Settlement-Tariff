...
<%Addcategory c=(Addcategory)request.getAttribute("s"); 
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<input type="hidden" id="c_id" name="c_id" value="<%=c.getC_id()%>">
										<div class="form-group">
											<label class="col-md-2 control-label" for="textinput"><span>Name</span></label>
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" name="c_name" value="<%=c.getC_name()%>"></div>
