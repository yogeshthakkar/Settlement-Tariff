...
<%@page import="com.dao.Addfeedback"%>
<%@page import="com.bean.addfeedback"%>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12"><h3 class="page-title">Manage Feedback</div></h3>
					</div>
												...
												<div class="col-sm-3">
													<div class="input-group">
														...
														<span class="input-group-btn"><button type="button" class="btn btn-search"><span><i class="fa fa-search"></i></span></button></span>
																		...
																		<%
										Addfeedback c=new Addfeedback();
										List<addfeedback> c1=c.getAllfeedback();
									%>							
									...
									<table class="table table-striped">
										...
										%>
											...
											<tr>
												...
												<td><%=s.getComment() %></td>
											    <td>
														<form name="delete" method="post" action="feedbackcon">
														<input type="hidden" name="fid" value="<%=s.getF_id()%>">
		 												<button class="btn btn-action-delete" name="add" value="delete">
