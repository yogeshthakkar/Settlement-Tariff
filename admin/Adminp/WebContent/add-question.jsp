								...
								<div class="panel-body">
									<form>
										<div class="form-group">
											<label class="col-md-2 control-label" for="textinput"><span>Question</span></label>
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" placeholder="Question"></div>
