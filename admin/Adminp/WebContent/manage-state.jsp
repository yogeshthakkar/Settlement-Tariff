		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12"><h3 class="page-title">Manage State<a href="add-state.jsp"><button type="button" class="btn btn-default right"><i class="fa fa-plus-square"></i> Add State</button></a></div></h3>
					</div>
							...
							<div class="panel">
								...
								<div class="panel-heading">
									<form>
										...
										<%Addstate sdao=new Addstate();
										List<addstate> c1=sdao.getAllstate();%>
									...
									<table id="example" class="table table-striped">
										...
										<%for(addstate c:c1){ %>
											<tr>
												...
												<td><%=c.getS_name()%></td>
													<td>
														<form name="edit" method="post" action="statecon">
														<input type="hidden" name="s_id" value="<%=c.getS_id()%>">
		 												<button class="btn btn-action-edit" name="submit" value="edit">
		 												<span class="fa fa-pencil"></span></button>
		 												</form>
		 										</td>
		 										<td>
		 											<form name="delete" method="post" action="statecon">
														<input type="hidden" name="s_id" value="<%=c.getS_id()%>">
