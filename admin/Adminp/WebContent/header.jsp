		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
				...
				<ul align="right">
					...
					%>	
						...
						%>
							...
							<a href="myprofile.jsp?id=<%=i %> "  >
														<span class="fa fa-user" aria-hidden="true"></span> My profile </a>
					 		<%}}catch(Exception e) 
						{e.printStackTrace();}
						%>
			...
			<% }%>
				...
				<div class="agileits_search">
					<form method="post" action="searchcon">
						<input name="search" type="search" id="search" placeholder="How can we help you today?" required>
						<button type="submit" class="btn btn-default" aria-label="Left Align" name="submit" value="search"onclick="searchInfo()">
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
 				...
 				<h3 class="agileinfo_sign">Sign In </h3>
						...
						<!-- <h3 class="agileinfo_sign">Sign In </h3>
						 --><p>
							Sign In now, Let's start your Settlement Experience. Don't have an account?
							<a href="#" data-toggle="modal" data-target="#myModal2">
								Sign Up Now</a>
						...
						<form action="loginuser" method="post">
							...
							<div class="styled-input" align="right">
							<a href="forgotpassword.jsp"><lable>Forgot Password</lable></a>
							</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
							Come join the Settlement Experience! Let's set up your Account.
						</p>
						<form action="loginuser" method="post">
							<div class="styled-input agile-styled-input-top">
							...
							<div class="styled-input">
								<input type="password" placeholder="Password" data-minlength="6" name="Password" required>
							</div>
							<div class="styled-input">
								<input type="password" placeholder="Confirm Password" data-minlength="6" name="ConfirmPassword" id="password2" required>
							</div>
							<div class="styled-input">
								<select name="u_type">
									<option>Select User Type:  </option>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li class="active">
									<a class="nav-stylehead" href="index1.jsp">Home
								...
								<li class="">
									<a class="nav-stylehead" href="postProperty.jsp">PostProperty</a>
								</li>
								
								
								<li class="">
									<a class="nav-stylehead" href="PG.jsp">PG</a>
								</li>
								
								
								<li class="">
									<a class="nav-stylehead" href="house.jsp">House</a>
								</li>
								<li class="">
									<a class="nav-stylehead" href="favourite.jsp">Favourite</a>
								</li>
