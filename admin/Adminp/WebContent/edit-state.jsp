...
<body>
<%addstate c=(addstate)request.getAttribute("s"); 
...
<%@include file="Navbar.jsp" %>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<form action="statecon" method="post">
									<input type="hidden" name="s_id" value="<%=c.getS_id()%>">
										<div class="form-group">
											<label class="col-md-2 control-label" for="textinput"><span>Name</span></label>
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" placeholder="" name="s_name" value="<%=c.getS_name()%>"></div>
	...
	<div class="clearfix"></div>
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2017 <a href="index.html" target="_blank">Settlement Tariff</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
