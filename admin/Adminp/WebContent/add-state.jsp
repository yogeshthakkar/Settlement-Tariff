...
<%@include file="Navbar.jsp" %>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#location" data-toggle="collapse" class="active"><i class="fa fa-location-arrow"></i> <span>Location Management</span><i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="location" class="collapse in">
								<ul class="nav">
									...
									<li><a href="#state" data-toggle="collapse" class="active"><i class="fa fa-building-o"></i>State Management<i class="icon-submenu lnr lnr-chevron-left"></i></a>
										<div id="state" class="collapse in">
											<ul class="nav">
												<li><a href="add-state.jsp" class="active">Add State</a></li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<form id="inputForm" action="statecon" method="dopost">
										<div class="form-group">
											<label class="col-md-2 control-label" for="textinput"><span>Name</span></label>
											<div class="col-md-8">
												<input type="text" class="form-control" id="textinput" name="s_name" placeholder="State Name" minlength="2" required>
											</div>
	...
	<div class="clearfix"></div>
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2017 <a href="index.jsp" target="_blank">Rudra Advertising</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
