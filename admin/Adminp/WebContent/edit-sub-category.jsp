...
Addsubcategory c=(Addsubcategory)request.getAttribute("s"); 
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<input type="hidden" id="c_id" name="sb_id" value="<%=c.getSb_id()%>">
										<div class="form-group">
											<label class="col-md-2 control-label" for="textinput"><span>Name</span></label>
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" name="sb_name" value="<%=c.getSb_name()%>"></div>
											<div class="clearfix"></div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label" for="textinput"><span>Status</span></label>
											<div class="col-md-8"><input type="text" class="form-control" id="textinput" name="status" value="<%=c.getStatus()%>"></div>
											<div class="clearfix"></div>
										</div>
