		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12"><h3 class="page-title">Manage City<a href="add-city.jsp"><button type="button" class="btn btn-default right"><i class="fa fa-plus-square"></i> Add City</button></a></div></h3>
					</div>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-heading">
									...
									<%
									Addcity adao=new Addcity();
										List<addcity> c1=adao.getAllcity();
									%>							
									...
									<table class="table table-striped">
										...
										%>
											...
											<tr>
												...
												<td><%=c.getC_name()%></td>
												<td>
														<form name="edit" method="post" action="citycon">
		 										...
		 										<td>
		 											<form name="delete" method="post" action="citycon">
														<input type="hidden" name="c_id" value="<%=c.getC_id()%>">
