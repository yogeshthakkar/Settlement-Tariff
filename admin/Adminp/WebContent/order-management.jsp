			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#order" data-toggle="collapse" class="active"><i class="lnr lnr-pencil"></i> <span>Order Management</span><i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="order" class="collapse in">
								<ul class="nav">
									<li><a href="order-management.jsp" class="active">Order Details</a></li>
