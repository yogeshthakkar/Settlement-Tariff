		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<div class="blog-post-single">
					...
					<a href="#" class="image">
						<img src="assets/images/portfolio-img-large-1.png" class="img-responsive img-rounded" />
					</a>
											
					<div class="post-details">
						
						<h3>
							<a href="blog-post.jsp">We hill lady will both sang room by</a>
						</h3>
					...
					<ul class="comments-list">
						...
						<li>
							...
							<div class="comment">
								<div class="comment-thumb">
									<a href="#">
										<img src="assets/images/user-icon-2@2x.png" class="img-circle" />
									</a>
								</div>
							...
							<ul>
								...
								<li>
									<div class="comment">
										<div class="comment-thumb">
											<a href="#">
												<img src="assets/images/user-icon-3@2x.png" class="img-circle" />
											</a>
										</div>
